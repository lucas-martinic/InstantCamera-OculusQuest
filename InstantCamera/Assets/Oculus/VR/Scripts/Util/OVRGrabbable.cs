...
public class OVRGrabbable : MonoBehaviour
{
    ...
    public UnityEvent onGrabR;
    public UnityEvent onGrabL;
    ...
    virtual public void GrabBegin(OVRGrabber hand, Collider grabPoint)
    {
        ...
        if (m_grabbedBy.m_controller == OVRInput.Controller.LTouch)
            onGrabL.Invoke();
        if (m_grabbedBy.m_controller == OVRInput.Controller.RTouch)
            onGrabR.Invoke();
            
        currentHand = hand.gameObject;
        currentHand.GetComponentInChildren<SkinnedMeshRenderer>().enabled = false;
    }
    ...
    virtual public void GrabEnd(Vector3 linearVelocity, Vector3 angularVelocity)
    {
        ...
        onUnGrab.Invoke();
        currentHand.GetComponentInChildren<SkinnedMeshRenderer>().enabled = true;
    }
